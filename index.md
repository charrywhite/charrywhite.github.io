...
1. **Lanpaint: Training-Free Diffusion Inpainting with Exact and Fast Conditional Inference**  
   ...
   <span style="display: inline-block; margin: 2px 4px; padding: 2px 8px; background-color: #e8f4fd; border-radius: 12px; font-size: 0.8em; color: #0066cc; text-decoration: none;">🐙 [Code](https://github.com/scraed/LanPaint)</span> [![](https://img.shields.io/github/stars/scraed/LanPaint?style=social)](https://github.com/scraed/LanPaint)
