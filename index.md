...
1. **Rethinking the Diffusion Model from a Langevin Perspective**  
   ...
   <a href="https://iclr-blogposts.github.io/2026/blog/2026/rethinking-diffusion-langevin/" style="display:inline-block;margin:2px 4px;padding:2px 8px;background-color:#f0f0f0;border:none;border-radius:12px;font-size:0.8em;font-family:inherit;color:#333;text-decoration:none;cursor:pointer;">📄 Blog</a><button onclick="(function(btn){var el=btn.nextElementSibling;el.style.display=el.style.display==='block'?'none':'block';})(this)" style="display:inline-block;margin:2px 4px;padding:2px 8px;background-color:#f0f0f0;border:none;border-radius:12px;font-size:0.8em;font-family:inherit;color:#333;cursor:pointer;">📋 BibTeX</button>
...
1. **Lanpaint: Training-Free Diffusion Inpainting with Exact and Fast Conditional Inference**  
   ...
   <a href="https://openreview.net/pdf?id=JPC8JyOUSW" style="display:inline-block;margin:2px 4px;padding:2px 8px;background-color:#f0f0f0;border:none;border-radius:12px;font-size:0.8em;font-family:inherit;color:#333;text-decoration:none;cursor:pointer;">📄 TMLR</a><a href="https://github.com/scraed/LanPaint" style="display:inline-block;margin:2px 4px;padding:2px 8px;background-color:#f0f0f0;border:none;border-radius:12px;font-size:0.8em;font-family:inherit;color:#333;text-decoration:none;cursor:pointer;">🐙 Code</a><a href="https://github.com/scraed/LanPaint/stargazers" style="display:inline-block;margin:2px 4px;vertical-align:middle;text-decoration:none;"><img src="https://img.shields.io/github/stars/scraed/LanPaint?style=flat&label=Stars&color=e0e0e0&labelColor=e0e0e0&logo=none" style="vertical-align:middle;border-radius:12px;height:1.5em;" alt="GitHub stars"></a><button onclick="(function(btn){var el=btn.nextElementSibling;el.style.display=el.style.display==='block'?'none':'block';})(this)" style="display:inline-block;margin:2px 4px;padding:2px 8px;background-color:#f0f0f0;border:none;border-radius:12px;font-size:0.8em;font-family:inherit;color:#333;cursor:pointer;">📋 BibTeX</button>
...
2. **Characteristic Guidance: Non-linear Correction for Diffusion Model at Large Guidance Scale**  
   ...
   <a href="https://proceedings.mlr.press/v235/zheng24f.html" style="display:inline-block;margin:2px 4px;padding:2px 8px;background-color:#f0f0f0;border:none;border-radius:12px;font-size:0.8em;font-family:inherit;color:#333;text-decoration:none;cursor:pointer;">📄 ICML</a><a href="https://github.com/scraed/CharacteristicGuidanceWebUI" style="display:inline-block;margin:2px 4px;padding:2px 8px;background-color:#f0f0f0;border:none;border-radius:12px;font-size:0.8em;font-family:inherit;color:#333;text-decoration:none;cursor:pointer;">🐙 Code</a><a href="https://github.com/scraed/CharacteristicGuidanceWebUI/stargazers" style="display:inline-block;margin:2px 4px;vertical-align:middle;text-decoration:none;"><img src="https://img.shields.io/github/stars/scraed/CharacteristicGuidanceWebUI?style=flat&label=Stars&color=e0e0e0&labelColor=e0e0e0&logo=none" style="vertical-align:middle;border-radius:12px;height:1.5em;" alt="GitHub stars"></a><button onclick="(function(btn){var el=btn.nextElementSibling;el.style.display=el.style.display==='block'?'none':'block';})(this)" style="display:inline-block;margin:2px 4px;padding:2px 8px;background-color:#f0f0f0;border:none;border-radius:12px;font-size:0.8em;font-family:inherit;color:#333;cursor:pointer;">📋 BibTeX</button>
...
3. **ElasticLaneNet: A Geometry-Flexible Approach for Lane Detection**  
   ...
   <a href="https://openaccess.thecvf.com/content/WACV2025/papers/Feng_ElasticLaneNet_An_Efficient_Geometry-Flexible_Lane_Detection_Framework_WACV_2025_paper.pdf" style="display:inline-block;margin:2px 4px;padding:2px 8px;background-color:#f0f0f0;border:none;border-radius:12px;font-size:0.8em;font-family:inherit;color:#333;text-decoration:none;cursor:pointer;">📄 WACV</a><button onclick="(function(btn){var el=btn.nextElementSibling;el.style.display=el.style.display==='block'?'none':'block';})(this)" style="display:inline-block;margin:2px 4px;padding:2px 8px;background-color:#f0f0f0;border:none;border-radius:12px;font-size:0.8em;font-family:inherit;color:#333;cursor:pointer;">📋 BibTeX</button>
...
5. **DOSnet as a Non-Black-Box PDE Solver: When Deep Learning Meets Operator Splitting**  
   **Yuan Lan**, Zhen Li&#42;, Jie Sun&#42;, Yang Xiang&#42;  
   ...
   <a href="https://www.sciencedirect.com/science/article/abs/pii/S0021999123004382" style="display:inline-block;margin:2px 4px;padding:2px 8px;background-color:#f0f0f0;border:none;border-radius:12px;font-size:0.8em;font-family:inherit;color:#333;text-decoration:none;cursor:pointer;">📄 Journal</a><button onclick="(function(btn){var el=btn.nextElementSibling;el.style.display=el.style.display==='block'?'none':'block';})(this)" style="display:inline-block;margin:2px 4px;padding:2px 8px;background-color:#f0f0f0;border:none;border-radius:12px;font-size:0.8em;font-family:inherit;color:#333;cursor:pointer;">📋 BibTeX</button>
...
6. **Feature Flow Regularization: Improving Structured Sparsity in Deep Neural Networks**  
   ...
   <a href="https://www.sciencedirect.com/science/article/abs/pii/S089360802300076X" style="display:inline-block;margin:2px 4px;padding:2px 8px;background-color:#f0f0f0;border:none;border-radius:12px;font-size:0.8em;font-family:inherit;color:#333;text-decoration:none;cursor:pointer;">📄 Journal</a><button onclick="(function(btn){var el=btn.nextElementSibling;el.style.display=el.style.display==='block'?'none':'block';})(this)" style="display:inline-block;margin:2px 4px;padding:2px 8px;background-color:#f0f0f0;border:none;border-radius:12px;font-size:0.8em;font-family:inherit;color:#333;cursor:pointer;">📋 BibTeX</button>
   <pre style="display:none;margin:6px 0 0 0;padding:10px;background:#f6f6f6;border:1px solid #ddd;border-radius:6px;font-size:0.78em;line-height:1.5;white-space:pre-wrap;">@article{WU2023598,
...
7. **An Elastic Interaction Based Loss Function for Medical Image Segmentation**  
   **Yuan Lan**, Yang Xiang, Luchan Zhang*  
   ...
   <a href="https://link.springer.com/chapter/10.1007/978-3-030-59722-1_73" style="display:inline-block;margin:2px 4px;padding:2px 8px;background-color:#f0f0f0;border:none;border-radius:12px;font-size:0.8em;font-family:inherit;color:#333;text-decoration:none;cursor:pointer;">📄 MICCAI</a><a href="https://github.com/charrywhite/elastic_interaction_based_loss" style="display:inline-block;margin:2px 4px;padding:2px 8px;background-color:#f0f0f0;border:none;border-radius:12px;font-size:0.8em;font-family:inherit;color:#333;text-decoration:none;cursor:pointer;">🐙 Code</a><a href="https://github.com/charrywhite/elastic_interaction_based_loss/stargazers" style="display:inline-block;margin:2px 4px;vertical-align:middle;text-decoration:none;"><img src="https://img.shields.io/github/stars/charrywhite/elastic_interaction_based_loss?style=flat&label=Stars&color=e0e0e0&labelColor=e0e0e0&logo=none" style="vertical-align:middle;border-radius:12px;height:1.5em;" alt="GitHub stars"></a><button onclick="(function(btn){var el=btn.nextElementSibling;el.style.display=el.style.display==='block'?'none':'block';})(this)" style="display:inline-block;margin:2px 4px;padding:2px 8px;background-color:#f0f0f0;border:none;border-radius:12px;font-size:0.8em;font-family:inherit;color:#333;cursor:pointer;">📋 BibTeX</button>
   <pre style="display:none;margin:6px 0 0 0;padding:10px;background:#f6f6f6;border:1px solid #ddd;border-radius:6px;font-size:0.78em;line-height:1.5;white-space:pre-wrap;">@InProceedings{10.1007/978-3-030-59722-1_73,
